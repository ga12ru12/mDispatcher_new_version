 ...
 *   `http://srv01.assets.example.com/`,?nbsp; `http://srv02.assets.example.com/`, etc.
...
!angular.$$csp() &amp;&amp; angular.element(document).find('head').prepend('&lt;style type="text/css"&gt;@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}&lt;/style&gt;');</pre><div id="window-resizer-tooltip" style="display: block;"><a href="https://code.angularjs.org/1.2.13/angular.js#" title="Edit settings"></a><span class="tooltipTitle">Window size: </span><span class="tooltipWidth" id="winWidth">1920</span> x <span class="tooltipHeight" id="winHeight">1050</span><br><span class="tooltipTitle">Viewport size: </span><span class="tooltipWidth" id="vpWidth">1920</span> x <span class="tooltipHeight" id="vpHeight">950</span></div></body></html>